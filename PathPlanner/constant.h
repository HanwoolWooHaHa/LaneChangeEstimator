...
//  13. Simulation for path planning
#define NUM_ADJ_VEHICLES 13
#define SAFETY_RANGE 20.0
#define PACKET_SIMUL_POSX 0
#define PACKET_SIMUL_POSY 1
#define PACKET_SIMUL_VELX 2
#define PACKET_SIMUL_VELY 3
